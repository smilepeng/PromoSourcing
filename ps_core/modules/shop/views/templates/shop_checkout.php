  ...
  <div class="container_12">
     <div class="grid_9">
		...
		<div style="float: right;">
			<p><a href="{site:url}index.php/shop/cart" class="btns button-yellow button-small">Update Order</a></p>
		</div>
		...
		<div style="float: right;">
			<p><a href="{site:url}index.php/shop/account/checkout" class="btns button-yellow button-small">Update Address</a></p>
		</div>
		<br class="clear" />
		...
		<form action="{shop:gateway}" method="post" class="default">
			...
			<div style="float:right">
				<a href="{site:url}index.php/shop/cancel" class="btns button-yellow button-small">Cancel Order</a>
				<input type="submit" value="Continue to Payment Page &gt;" style="font-weight: bold;" class="btns button-yellow button-small" />
			</div>
			<br class="clear" />
