...
<section id="content">
  <div class="container_12">
     <div class="grid_12">
      <div class="breadcrumbs">
        <p><span class="bread-home"><a href="{site:url}">Home</a></span><span><a href="{page:baseUrl}/shop/orders">Orders</a></span>Order {order:id}</p>
      </div>
    </div>
  ...
  <div class="container_12">
     <div class="grid_9">
		...
		<h1>Order ID #: <strong>{order:id}</strong> </h1>
	...
	<div class="grid_3">
		...
		<ul class="menu">
			<li><a href="{site:url}index.php/shop">Back to Shop</a></li>
			<li><a href="{site:url}index.php/shop/account">My Account</a></li>		
			<li><a href="{site:url}index.php/shop/cart">My Shopping Cart</a></li>
			<li><a href="{site:url}index.php/shop/subscriptions">My Subscriptions</a></li>			
			<li><a href="{site:url}index.php/shop/orders">My Orders</a></li>	
			<li><a href="{site:url}index.php/shop/appointments">My Appointments</a></li>	
		</ul>
