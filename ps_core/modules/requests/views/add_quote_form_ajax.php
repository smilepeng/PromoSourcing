...
<a class="window_close" href="#"><img src="<?php echo $this->config->item('staticPath'); ?>/images/btn_close.png" alt="Close" class="padded"></a><span class="window_title">Add Quote</span>
...
<div class="headingright">
	<a  class="button save " id="add_quoted_product">Add Quote</a>
</div>
</form>
<!-- The file uploads will be shown here -->
