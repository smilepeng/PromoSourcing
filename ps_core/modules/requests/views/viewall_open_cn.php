...
<h1 class="headingleft">所有未接客户单</h1>
<br/>
		...
		<?php if (in_array('requests_edit', $this->permission->permissions)): ?>
				<a href="<?php echo site_url('/admin/requests/add'); ?>" class="button compact icon-plus">添加客户需求</a>
			<?php endif; ?>
		</p>
		...
		<table class="table responsive-table responsive-table-on dataTable" id="sorting-advanced" aria-describedby="sorting-advanced_info">
				...
				<thead>
					...
					<th scope="col" width="15%" class="sorting" role="columnheader" tabindex="0" aria-controls="sorting-advanced" rowspan="1" colspan="1" aria-label="Customer" style="width: 160px;">图片</th>
						...
						<td class="low-padding ">
							<span class="button-group compact">
								...
								<?php endif; ?>
										<!-- Sale team -->
							<?php if (in_array('requests_edit', $this->permission->permissions)): ?>
								<?php echo anchor('/admin/requests/edit/'.$request['productID'], '编辑',  'class="button icon-pencil with-tooltip" title="Edit this Request"'); ?>
							<?php endif; ?>						
