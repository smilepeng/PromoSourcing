...
<a class="window_close" href="#"><img src="<?php echo $this->config->item('staticPath'); ?>/images/btn_close.png" alt="Close" class="padded"></a><span class="window_title">Add Request for product</span>
...
<div id="window_scroll">
	...
	<input type="hidden" name="imgs" id="imgs" value="<?php echo   array_key_exists('imgs', $data )?$data['imgs']:''; ?>" />
	</form>	
...
<div class="headingright">
	<a  class="button save " id="add_requested_product">Add Product</a>
</div>
