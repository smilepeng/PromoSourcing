...
<div style="float: right;">
	...
	?>	
	<?php echo ($thumb = display_image($imageThumbPath, $data['imageName'], 100, 'class="pic" ', FALSE, $sitePath)) ? $thumb : display_image($imagePath, $data['imageName'], 100, 'class="pic"', FALSE, $sitePath); ?>		
</div>
