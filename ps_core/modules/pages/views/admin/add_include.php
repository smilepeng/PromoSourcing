...
<?php if ($type == 'css'): ?>
	...
	<?php echo @form_input('includeRef',set_value('includeRef',  array_key_exists('includeRef', $data )?$data['includeRef'] : ''), 'id="includeRef" class="formelement"'); ?>
...
<?php endif; ?>
	...
	<div class="autosave">
		...
		<?php echo @form_textarea('body',set_value('body',  array_key_exists('body', $data )?$data['body'] : ''), 'id="body" class="code editor"'); ?>
		<br class="clear" />
	</div>
