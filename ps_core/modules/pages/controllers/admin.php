...
class Admin extends MX_Controller {
	...
	function __construct()
	{
		...
		//log_message('error', 'permission: '.print_r($this->permission->permissions, true));
	...
	function edit($pageID)
	{
		...
		if (( array_key_exists('versionID', $pagedata)&& array_key_exists('draftID', $pagedata) &&!$pagedata['versionID'] && !$pagedata['draftID']) || @in_array($pagedata['draftID'], $versionIDs))
		{
	...
	function add_block($versionID, $block, $pageID) //Edited by smy ($versionID, $block)
	{	
		...
		{			
			...
			{			
				...
				// add block
				@$this->core->add_block($body, $versionID, $block, $pageID);//Edited by smy ($body, $versionID, $block)
