...
<div id="siteconfig" class="tab">
	...
	<label for="siteEmail">Email:(This email will be used to send contact customer)</label>
	...
	<br class="clear" />
    <label for="siteMapLongitude">Map Coordinate Longitude:</label>
	<?php echo @form_input('siteMapLongitude', set_value('siteMapLongitude', $data['siteMapLongitude']), 'id="siteMapLongitude" class="formelement"'); ?>
	<label for="siteMapLatitude">Map Coordinate Latitude:</label>
	<?php echo @form_input('siteMapLatitude', set_value('siteMapLatitude', $data['siteMapLatitude']), 'id="siteMapLatitude" class="formelement"'); ?>
	<br class="clear" />
	<label for="siteTradingHours">Trading hours:</label>
	<?php echo @form_textarea('siteTradingHours', set_value('siteTradingHours', $data['siteTradingHours']), 'id="siteTradingHours" class="formelement small"'); ?>
	<br class="clear" />
