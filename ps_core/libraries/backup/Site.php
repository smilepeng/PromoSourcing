...
class Site {
	...
	function _init_site()
	{
		...
		if ($this->CI->db->get('sites')->num_rows() !== 0)
		{
			...
			{
				show_error('This domain '. $siteDomain.' has not been configured properly.');
			}
		}
	...
	function _login_cookie()
	{
		...
		{
			if ($cookie = get_cookie($this->cookieName))
			{
				// get cookie
